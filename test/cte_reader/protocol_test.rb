...
describe CteReader::Protocol do
  def nfe_hash
    {
      infProt: {
        tpAmb: '1',
        Id: '10398210938021938',
        verAplic: 'SVRS2000101120000',
        chCTe: '12300384950081649000148500001000001310002342',
  ...
  let(:protocol) { CteReader::Protocol.new(nfe_hash) }
  ...
  it '#cte_id' do
    protocol.cte_id.must_equal '10398210938021938'
  end
